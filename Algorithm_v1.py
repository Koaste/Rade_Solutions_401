...
# SVR = Static Vehicle Route (of a specific Static Vehicle Routing Decision)
SVR_number = 1
...
# setting the 3rd input to true, will add 5.5 to all previous costs!
Vissim.Net.Links.SetAllAttValues(Attribute, Cost, True)
...
vehicle_type = 100
# unit according to the user setting in Vissim [km/h or mph]
desired_speed = 53
link = 1
lane = 1
