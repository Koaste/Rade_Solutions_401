...
# once the cache has been generated, its faster to call Dispatch which also creates theconnection to Vissim.
...
# Note that in Python tuple the 1st element is called by 0, although in Vissim GUI its numberis 1!
...
# To run the simulation continuous (it stops at breakpoint or end of simulation):
sim.RunContinuous()
